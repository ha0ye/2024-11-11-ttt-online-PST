...
venue: "Carpentries ONLINE Instructor Training"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "online"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "NA"      # "W3" for centrally organized online trainings or lowercase two-letter ISO country code such as "fr" of the host institution if applicable (see https://en.wikipedia.org/wiki/ISO_3166-1)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/ISO_639-1)
latitude: "NA"        # decimal latitude of training venue (use https://www.latlong.net/)
longitude: "NA"       # decimal longitude of the training venue (use https://www.latlong.net)
humandate: "Nov 11-14, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am PT - 12:00pm PT"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Trisha Adamus", "Hao Ye"] # boxed, comma-separated list of trainers' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["Trisha Adamus <adamus@wisc.edu>", "Hao Ye <Lhopitalified@gmail.com>"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
